...
options_site = [{'label': i, 'value': i} for i in spacex_df['Launch Site'].unique()]
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        site_df = spacex_df[spacex_df['Launch Site'] == entered_site].groupby('class').size()
        fig = px.pie(site_df, values=site_df, 
        names=site_df.index.astype(str),
