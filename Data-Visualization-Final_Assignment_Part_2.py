...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemployment_rate= data.groupby('Vehicle_Type')['unemployment_rate'].sum().reset_index()
        R_chart4  = dcc.Graph(
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, 
                x='Year',
                y='Automobile_Sales',
                title="Average Automobile Sales fluctuation over Yearly Report"))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(figure=px.line(yas, 
                x='Month',
                y='Automobile_Sales',
                title="Total Automobile Sales fluctuation over Yearly Report"))
        ...
        Y_chart4 = dcc.Graph(
                    ...
                    values='Advertising_Expenditure',
                 names='Vehicle_Type',
                 title="Total Advertisement expenditure by vehicle type yearly"
                )
            )
